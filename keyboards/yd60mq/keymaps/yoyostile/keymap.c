...
void keyboard_post_init_user(void) {
  ...
  rgblight_sethsv_noeeprom(77, 163, 175);
...
/*2_*/ KC_LCTL, KC_A,     KC_S,   KC_D,    KC_F,   KC_G,   KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT, _______, KC_ENT,
/*3_*/ KC_LSFT, KC_NO,    KC_Z,   KC_X,    KC_C,   KC_V,   KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  _______, KC_RSFT, MO(_MEDIA),
/*4_*/ KC_LCTL, KC_LALT,  KC_LGUI,_______, KC_SPC, _______, MO(_FN), _______, KC_RGUI, KC_RCTL, _______),
...
/*2_*/ KC_LCTL,      RCMD(KC_A), RCMD(KC_S), KC_PGDN,    RCMD(KC_F), RCMD(KC_G), KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,      RCMD(KC_SCLN), RCMD(KC_QUOT), _______,       RCMD(KC_ENT),
/*3_*/ KC_TRNS,      KC_NO,      RCMD(KC_Z), RCMD(KC_X), RCMD(KC_C), RCMD(KC_V), KC_BYEBUG,  RCMD(KC_N), RCMD(KC_M), RCMD(KC_COMM), RCMD(KC_DOT),  RCMD(KC_SLSH), _______,       RCMD(KC_RSFT), MO(_MEDIA),
